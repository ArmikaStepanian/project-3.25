...
INSERT INTO `backpack` VALUES (210,1,'Street 33 L'),(211,2,'Burto 23 L'),(212,3,'Pinky 18 L');
...
INSERT INTO `brand` VALUES (1,'Dakine'),(2,'Burton'),(3,'Roxy');
...
INSERT INTO `users` VALUES ('admin','$2a$10$asuzyigZzQuSLEQcNJxdCuH7sqi2M0d.rbqdSs5ufXfgoSFJ4nF4S',1),('user','$2a$10$E9vAHrFOAvywPgSB86xZvOqBdwjZL5/zfQ/tRPjGEBfPvIdIwAtq6',1);
...
/*!50001 VIEW `new_view` AS select `bp`.`name` AS `backpack`,`br`.`name` AS `brand` from (`backpack` `bp` join `brand` `br` on((`bp`.`brand` = `br`.`id`))) */;
...
-- Dump completed on 2016-04-04 17:56:12
